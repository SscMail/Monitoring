...
$clientId = Get-AutomationVariable -Name 'PCClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'PCTenantID'
$redirectUri = Get-AutomationVariable -Name 'PCURIRedirec'
...
$SenderCredential = Get-AutomationPSCredential -Name 'PCMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'PCMailFlowReceiver'
