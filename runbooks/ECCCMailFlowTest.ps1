...
$clientId = Get-AutomationVariable -Name 'ECCCClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'ECCCTenantID'
$redirectUri = Get-AutomationVariable -Name 'ECCCURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'ECCCMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'ECCCMailFlowReceiver'
