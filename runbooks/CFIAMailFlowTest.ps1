...
$clientId = Get-AutomationVariable -Name 'CFIAClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'CFIATenantID'
$redirectUri = Get-AutomationVariable -Name 'CFIAURIRedirec'
...
$SenderCredential = Get-AutomationPSCredential -Name 'CFIAMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'CFIAMailFlowReceiver'
