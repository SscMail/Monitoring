...
$clientId = Get-AutomationVariable -Name 'PSClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'PSTenantID'
$redirectUri = Get-AutomationVariable -Name 'PSURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'PSMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'PSMailFlowReceiver'
