...
$clientId = Get-AutomationVariable -Name 'IAACClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'IAACTenantID'
$redirectUri = Get-AutomationVariable -Name 'IAACURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'IAACMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'IAACMailFlowReceiver'
