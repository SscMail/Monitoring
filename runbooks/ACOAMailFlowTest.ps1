...
$clientId = Get-AutomationVariable -Name 'ACOAClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'ACOATenantID'
$redirectUri = Get-AutomationVariable -Name 'ACOAURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'ACOAMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'ACOAMailFlowReceiver'
