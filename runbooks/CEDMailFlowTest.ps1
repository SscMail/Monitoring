...
$clientId = Get-AutomationVariable -Name 'CEDClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'CEDTenantID'
$redirectUri = Get-AutomationVariable -Name 'CEDURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'CEDMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'CEDMailFlowReceiver'
