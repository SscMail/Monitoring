...
$clientId = Get-AutomationVariable -Name 'PSCClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'PSCTenantID'
$redirectUri = Get-AutomationVariable -Name 'PSCURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'PSCMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'PSCMailFlowReceiver'
