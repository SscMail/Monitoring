...
$clientId = Get-AutomationVariable -Name 'ISEDClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'ISEDTenantID'
$redirectUri = Get-AutomationVariable -Name 'ISEDURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'ISEDMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'ISEDMailFlowReceiver'
