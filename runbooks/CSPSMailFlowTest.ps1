...
$clientId = Get-AutomationVariable -Name 'CSPSClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'CSPSTenantID'
$redirectUri = Get-AutomationVariable -Name 'CSPSURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'CSPSMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'CSPSMailFlowReceiver'
