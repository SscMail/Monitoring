...
$clientId = Get-AutomationVariable -Name 'VACClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'VACTenantID'
$redirectUri = Get-AutomationVariable -Name 'VACURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'VACMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'VACMailFlowReceiver'
