...
$clientId = Get-AutomationVariable -Name 'WDClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'WDTenantID'
$redirectUri = Get-AutomationVariable -Name 'WDURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'WEDMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'WEDMailFlowReceiver'
