...
$clientId = Get-AutomationVariable -Name 'TCClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'TCTenantID'
$redirectUri = Get-AutomationVariable -Name 'TCURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'TCMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'TCMailFlowReceiver'
