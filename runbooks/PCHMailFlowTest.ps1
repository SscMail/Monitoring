...
$clientId = Get-AutomationVariable -Name 'PCHClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'PCHTenantID'
$redirectUri = Get-AutomationVariable -Name 'PCHURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'PCHMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'PCHMailFlowReceiver'
