...
$clientId = Get-AutomationVariable -Name 'LACClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'LACTenantID'
$redirectUri = Get-AutomationVariable -Name 'LACURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'LACMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'LACMailFlowReceiver'
