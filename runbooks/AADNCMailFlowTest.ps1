...
$redirectUri = Get-AutomationVariable -Name 'AADNCURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'AADNCMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'AADNCMailFlowReceiver'
