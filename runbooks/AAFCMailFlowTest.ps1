...
$clientId = Get-AutomationVariable -Name 'AAFCClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'AAFCTenantID'
$redirectUri = Get-AutomationVariable -Name 'AAFCURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'AAFCMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'AAFCMailFlowReceiver'
