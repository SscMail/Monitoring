...
$clientId = Get-AutomationVariable -Name 'FINClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'FINTenantID'
$redirectUri = Get-AutomationVariable -Name 'FINURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'FINMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'FINMailFlowReceiver'
