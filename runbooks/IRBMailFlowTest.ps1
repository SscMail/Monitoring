...
$redirectUri = Get-AutomationVariable -Name 'IRBURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'IRBMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'IRBMailFlowReceiver'
