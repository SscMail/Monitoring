...
$clientId = Get-AutomationVariable -Name 'NRCanClientIDMailflow'
$tenantId = Get-AutomationVariable -Name 'NRCanTenantID'
$redirectUri = Get-AutomationVariable -Name 'NRCanURIRedirect'
...
$SenderCredential = Get-AutomationPSCredential -Name 'NRCanMailFlowSender'
$ReceiverCredential = Get-AutomationPSCredential -Name 'NRCanMailFlowReceiver'
